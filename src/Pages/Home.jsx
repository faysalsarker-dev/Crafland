    ...
    return (
        <div>
            ...
            <div className="space-y-3 px-4 my-10">
                ...
                <div className="grid md:grid-cols-3 grid-cols-1 gap-3 text-[#323743]">
                    ...
                    <div className=" md:col-span-2 bg-[#D3C1FA]  p-5 rounded-xl">
                    ...
                    <div className="bg-[#FDCFC4] p-5 rounded-xl md:col-span-2 flex justify-start">
                            <div>
            ...
            <div className="flex justify-start p-2">
                <h3 className="text-center text-4xl font-extrabold my-8 border-b-2 pb-3 border-b-[#6D31ED]">Trending products</h3>
            </div>
            ...
            <div className="bg-[#8E61F1] text-center p-8 rounded-2xl space-y-7 my-6">
                <h3 className="text-center text-4xl font-bold text-white">Getting started for free</h3>
