...
const Register = () => {
    ...
    return (
        ...
        <div className="card  w-full max-w-sm  my-6">
            ...
            <form onSubmit={handleRegister} className="card-body">
                ...
                <p>New hare <Link to='/login' className=" link link-hover text-primary">Login now</Link></p>
            </form>

            <div className=" px-14 "> <div className="divider">OR</div></div>
            <div className="grid grid-cols-2 gap-3  px-8">

                <div className="flex gap-2 items-center text-center justify-center border border-black p-2 rounded-full cursor-pointer" > <FaGoogle /> Google</div>
